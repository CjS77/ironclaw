...
registerPack("en", {
  ...
  "login.localDevHint": "Running Naomi locally? Get your sign-in link:",
  ...
  // Chat — input
  "chat.placeholder": "Message Naomi...",
  "chat.heroPlaceholder": "Ask Naomi anything.",
  ...
  "chat.busyRejectedResend":
    "This message wasn't sent because Naomi was busy. Resend it to try again.",
  "chat.identityUser": "You",
  "chat.identityAssistant": "Naomi",
  ...
  "restart.progressTitle": "Restarting Naomi",
  ...
  "onboarding.title": "Welcome to Naomi",
  ...
  "tools.description.builtin.trace_commons.onboard": "Enroll this Naomi in Trace Commons using an operator-issued invite link after explicit user consent.",
  ...
  "projects.empty.noneDesc":
    "Projects appear once the assistant creates durable workspaces. You can start from chat and ask Naomi to spin up a scoped project for ongoing work.",
...
registerPack("en", {
  ...
  "telegramSetup.instructions": "Create a bot with @BotFather and paste its token. Naomi registers the webhook for you.",
